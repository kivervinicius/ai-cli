...
2. **One React Frontend**: Um único SPA React compilado em `web/src -> web/dist`, copiado para o diretório gerado `internal/control/web/embedded`, é embarcado no servidor web e na casca Wails (`web.EmbeddedDistFS()`).
