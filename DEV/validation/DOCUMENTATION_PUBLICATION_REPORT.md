...
- Final documentation SHA: `75a9df4` (local worktree branch)
...
The Web visual coverage is complete for the captured surfaces. Native Desktop
remains unavailable in this Linux capture environment and is not claimed as
captured.
...
`NO-GO` for publication: the Web evidence and documentation gates pass, but
native Desktop still has no real capture in this Linux environment. A native
Desktop capture on the supported OS must be added before changing this verdict.
